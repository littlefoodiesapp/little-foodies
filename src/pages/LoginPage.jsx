  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f9fafb',
      ...
      <div style={{ background: '#fff', borderRadius: 20, padding: '36px 28px',
        width: '100%', maxWidth: 400, border: '0.5px solid #e5e7eb',
        ...
        <div style={{ textAlign: 'center', marginBottom: 28 }}>
          ...
          <p style={{ fontSize: 13, color: '#6b7280' }}>
            {mode === 'signin' ? 'Welcome back!' : 'Join your local family food community'}
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          ...
          {error && (
            <div style={{ fontSize: 12, marginBottom: 14, padding: '9px 12px',
              background: error.includes('confirm') ? '#fefae8' : '#fef2f2',
              color: error.includes('confirm') ? '#854d0e' : '#ef4444',
          ...
          <button type="submit" disabled={loading}
            style={{ width: '100%', padding: '13px 0', background: '#f57b46',
              ...
              boxShadow: '0 4px 14px rgba(245,123,70,.35)', ...font }}>
        ...
        <p style={{ textAlign: 'center', marginTop: 20, fontSize: 12, color: '#6b7280' }}>
          {mode === 'signin' ? 'New to Little Foodies? ' : 'Already have an account? '}
          <button
            onClick={() => { setMode(m => m === 'signin' ? 'signup' : 'signin'); setError(null) }}
            style={{ color: '#f57b46', background: 'none', border: 'none',
              cursor: 'pointer', fontWeight: 600, fontSize: 12, ...font }}>
