...
const BRAND = {
  orange: '#f57b46', teal: '#00a994', pink: '#f46ab8',
  yellow: '#fbca3f', blue: '#0692e5',
  orLt: '#fff3ee', tlLt: '#e6f7f5', pkLt: '#fef0f8',
  ywLt: '#fefae8', blLt: '#e8f4fd',
  orBd: '#fdc9b0', tlBd: '#99ddd6', pkBd: '#f9b8e0',
  ywBd: '#fde9a0', blBd: '#9ed4f6',
}
